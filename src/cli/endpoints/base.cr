      ...
      private def print_help : Nil
        puts <<-TXT
          ...
          Commands:
            ...
            build [SERVICE|PATH] --remote HOST [--manager NAME] [--start-mode] [--deploy --namespace NAME]
            ...
            start [PATH] [-d] [--port N] [--log-level LEVEL]
                Build/update a minimal Cawfile container and start the optimized runtime API.
                PATH: optional workflow directory (default: current directory)
                -d/--detach: run in background
